...
object PetDialoguesV2 {
    ...
    fun getFeatureTipMessage(personality: PetPersonalityV2): String {
        val tips = when (personality) {
            PetPersonalityV2.LOYAL -> listOf(
                "위젯 설정하면 홈에서 바로 확인 가능해.",
                "챌린지 완료하면 칭호를 얻을 수 있어.",
                "스킨은 목표 달성하면 해금돼. 설정에서 봐.",
                "연속 달성하면 방어 티켓이 생겨.",
                "명언 위젯도 있어. 추천해.",
                "날씨 위젯에서 산책 타이밍 확인해."
            )
            PetPersonalityV2.TSUNDERE -> listOf(
                "위젯... 설정해두면 편해. 알려주는 거야.",
                "챌린지하면 칭호 준대. ...관심 있으면.",
                "스킨 바꿀 수 있어. 설정에서... 뭐, 관심 없으면 됐어.",
                "연속 달성하면 방어 티켓이... 알아둬.",
                "명언 위젯도 있는데... 그냥 알려주는 거야.",
                "날씨 위젯 유용해. ...칭찬 아니야."
            )
            PetPersonalityV2.FOODIE -> listOf(
                "위젯 설정하면 밥 먹으면서도 확인 가능해!",
                "챌린지하면 칭호 줘! 맛있는 칭호?!",
                "스킨 있어! 밥 먹은 만큼 이뻐진다?! 아닌가?!",
                "연속 달성하면 방어 티켓! 밥처럼 모아!",
                "명언 위젯! 명언 읽으면서 밥 먹자!",
                "날씨 위젯! 비 오면 집에서 밥!"
            )
            PetPersonalityV2.PLAYFUL -> listOf(
                "위젯 설정해! 홈에서 바로 보면 재밌어!",
                "챌린지하면 칭호 줘! 모으면 재밌지!",
                "스킨 바꿀 수 있어! 나 이쁘지?!",
                "연속 달성하면 방어 티켓! 모으자모으자!",
                "명언 위젯도 있어! 읽으면 힘나!",
                "날씨 위젯! 맑으면 산책 고고!"
            )
            PetPersonalityV2.TIMID -> listOf(
            ...
            PetPersonalityV2.CLUMSY -> listOf(
                "위젯 설정해! 앗 설정 버튼 어디- 찾았다!",
                "챌린지하면 칭호 줘! 앗 버튼 잘못 눌렀다!",
                "스킨 바꿀 수 있어! 나 이뻐- 앗 거울에 부딪혀!",
                "연속 달성하면 방어 티켓! 어 이거 좋은- 앗!",
                "명언 위젯! 읽다가 넘어지지 않게 조심!",
                "날씨 위젯! 비 오면 미끄러우니까 조심!"
            )
        }
        return tips.random()
    }
